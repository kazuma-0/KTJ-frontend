      ...
      <div className='grid lg:grid-cols-4 gap-x-5'>
        <Box p={5} borderWidth='1px' borderRadius='lg' overflow='hidden'>
          ...
          <Box display='flex' flexDirection={'column'} alignItems={'baseline'}>
            ...
            <Badge backgroundColor={'#3498db'} mt='3' color={'black'}>
              Matrix
            </Badge>
            <Text p={3}>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi
              culpa deserunt eaque eligendi illo quae rem temporibus vero! Ab,
              aliquam architecto asperiores commodi cum ea eius magni suscipit
              velit voluptas.
            </Text>
          </Box>
        </Box>
        <Box p={5} borderWidth='1px' borderRadius='lg' overflow='hidden'>
          ...
          <Box display='flex' flexDirection={'column'} alignItems={'baseline'}>
            ...
            <Badge backgroundColor={'#f1c40f'} mt={2} color={'black'}>
              Root
            </Badge>
            <Text p={3}>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi
